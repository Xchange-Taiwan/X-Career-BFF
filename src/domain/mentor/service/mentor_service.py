...
class MentorService:
    def __init__(self, mentor_repository: MentorRepository,
                 ...
                 industry_repository: ProfessionRepository):
        ...
        self.__industry_repository: ProfessionRepository = industry_repository
        self.__profile_repository = profile_repository

    def upsert_mentor_profile(self, profile_dto: MentorProfileDTO, db: Session) -> MentorProfileVO:
    ...
    def get_mentor_profile_by_id(self, mentor_profile_dto: MentorProfileDTO, db: Session) -> MentorProfileVO:
        return self.convert_to_mentor_profile_VO(
            self.__mentor_repository.get_mentor_profile_by_id(db, mentor_profile_dto.user_id))
